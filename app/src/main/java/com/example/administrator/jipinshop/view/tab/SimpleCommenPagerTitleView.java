...
public class SimpleCommenPagerTitleView extends TextView implements IMeasurablePagerTitleView {
    ...
    public SimpleCommenPagerTitleView(Context context ,int leftPadding , int rightPadding) {
        super(context, null);
        init(context,leftPadding,rightPadding);
    }

    private void init(Context context,int leftPadding , int rightPadding) {
