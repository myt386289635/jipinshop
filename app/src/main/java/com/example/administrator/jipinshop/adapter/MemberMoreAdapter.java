...
public class MemberMoreAdapter extends RecyclerView.Adapter<MemberMoreAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        int zWidth = (int) (DistanceHelper.getAndroiodScreenwidthPixels(mContext) - mContext.getResources().getDimension(R.dimen.x20) - mContext.getResources().getDimension(R.dimen.x20));
