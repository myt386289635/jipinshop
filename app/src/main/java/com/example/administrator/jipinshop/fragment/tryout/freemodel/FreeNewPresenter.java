 ...
 * @Describe
 */
public class FreeNewPresenter {

    private Repository mRepository;
    private FreeNewView mView;

    public void setView(FreeNewView view) {
        mView = view;
    }

    @Inject
    public FreeNewPresenter(Repository repository) {
