 ...
 * @Describe
 */
public class ShopDescriptionAdapter extends RecyclerView.Adapter{
    ...
    public ShopDescriptionAdapter(Context context, List<FreeDetailBean.DataBean.GoodsContentListBean> list) {
        mContext = context;
        mList = list;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        switch (type){
            ...
            case IMG:
                ...
                imgViewHolder.mImageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
                break;
        }
    }
