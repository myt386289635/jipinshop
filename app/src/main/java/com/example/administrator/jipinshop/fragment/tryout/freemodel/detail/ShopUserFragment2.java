 ...
 * @Describe
 */
public class ShopUserFragment2  extends DBBaseFragment implements OnRefreshListener, OnLoadMoreListener, ShopUserView{
    ...
    public static ShopUserFragment2 getInstance(String id ,String fee) {
        ShopUserFragment2 fragment = new ShopUserFragment2();
