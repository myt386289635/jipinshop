 ...
 * @Describe 百科首页
 */
public class EncyclopediasAdapter extends RecyclerView.Adapter<EncyclopediasAdapter.ViewHolder>{
    ...
    public EncyclopediasAdapter(List<FindDetailBean.DataBean.RelatedArticleListBean> list, Context context) {
        mList = list;
        mContext = context;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.item_name.setTypeface(Typeface.defaultFromStyle(Typeface.NORMAL));
        GlideApp.loderRoundImage(mContext,mList.get(i).getImg(),viewHolder.item_image,0,0);
        viewHolder.item_time.setText(mList.get(i).getPv() + "阅读");
