...
import com.example.administrator.jipinshop.fragment.home.kitchen.KitchenFragmentPresenter;
...
public class KitchenFragmentRecyclerAdapter extends RecyclerView.Adapter<KitchenFragmentRecyclerAdapter.ViewHolder> {
    ...
    private KitchenFragmentPresenter mPresenter;
    ...
    public KitchenFragmentRecyclerAdapter(List<String> list, Context context, KitchenFragmentPresenter presenter) {
        mList = list;
        mContext = context;
    ...
    public KitchenFragmentRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.kitchen_item, viewGroup, false);
        KitchenFragmentRecyclerAdapter.ViewHolder holder = new KitchenFragmentRecyclerAdapter.ViewHolder(view);
        return holder;
    }
