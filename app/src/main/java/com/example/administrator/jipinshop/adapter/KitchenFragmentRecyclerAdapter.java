...
import com.example.administrator.jipinshop.databinding.KitchenItemBinding;
import com.example.administrator.jipinshop.view.glide.imageloder.ImageManager;

import java.math.BigDecimal;
import java.util.List;

public class KitchenFragmentRecyclerAdapter extends RecyclerView.Adapter<KitchenFragmentRecyclerAdapter.ViewHolder> {

    private List<KitchenFragmentBean.ListBean> mList;
    ...
    public KitchenFragmentRecyclerAdapter(List<KitchenFragmentBean.ListBean> list, Context context) {
        mList = list;
        mContext = context;
    }
    ...
    @NonNull
    @Override
    public KitchenFragmentRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        KitchenItemBinding kitchenItemBinding = DataBindingUtil.inflate(LayoutInflater.from(mContext),R.layout.kitchen_item,viewGroup, false);
        ViewHolder holder = new ViewHolder(kitchenItemBinding);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull KitchenFragmentRecyclerAdapter.ViewHolder viewHolder, final int position) {
        ...
        if (position == 0) {
            viewHolder.mBinding.itemTitleContanier.setPadding(0, mContext.getResources().getDimensionPixelSize(R.dimen.x36), 0, 0);
        }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private KitchenItemBinding mBinding;

        public ViewHolder(KitchenItemBinding binding) {
            super(binding.getRoot());
            this.mBinding = binding;
        }

        public KitchenItemBinding getBinding() {
            return mBinding;
        }
    }
