...
public class HouseholdFragmentRecyclerAdapter extends RecyclerView.Adapter<HouseholdFragmentRecyclerAdapter.ViewHolder>{

    private List<String> mList;
    private Context mContext;
    private HouseholdFragmentPresenter mPresenter;
    ...
    public HouseholdFragmentRecyclerAdapter(List<String> list, Context context, HouseholdFragmentPresenter presenter) {
        mList = list;
        mContext = context;
    ...
    @NonNull
    @Override
    public HouseholdFragmentRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {

        View view = LayoutInflater.from(mContext).inflate(R.layout.household_item, viewGroup, false);
        HouseholdFragmentRecyclerAdapter.ViewHolder holder = new HouseholdFragmentRecyclerAdapter.ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull HouseholdFragmentRecyclerAdapter.ViewHolder viewHolder, final int position) {
