...
import com.example.administrator.jipinshop.fragment.home.electricity.ElectricityFragmentPresenter;
...
public class ElectricityFragmentRecyclerAdapter extends RecyclerView.Adapter<ElectricityFragmentRecyclerAdapter.ViewHolder>{
    ...
    private ElectricityFragmentPresenter mPresenter;
    ...
    public ElectricityFragmentRecyclerAdapter(List<String> list, Context context, ElectricityFragmentPresenter presenter) {
        mList = list;
        mContext = context;
    ...
    public ElectricityFragmentRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.electricity_item, viewGroup, false);
        ElectricityFragmentRecyclerAdapter.ViewHolder holder = new ElectricityFragmentRecyclerAdapter.ViewHolder(view);
        return holder;
    }
