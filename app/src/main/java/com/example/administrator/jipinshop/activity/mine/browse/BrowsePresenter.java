...
public class BrowsePresenter {
    ...
    @Inject
    public BrowsePresenter(Repository repository) {
    ...
    public void goodsHistory(int page , LifecycleTransformer<TBSreachResultBean> transformer){
        mRepository.goodsHistory(page)
