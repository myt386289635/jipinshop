 ...
 * @Describe
 */
public class SeckillDetailPresenter {

    private Repository mRepository;
    private SeckillDetailView mView;

    public void setView(SeckillDetailView view) {
        mView = view;
    }

    @Inject
    public SeckillDetailPresenter(Repository repository) {
    ...
    public void seckillDetail(int type, String seckillGoodsId, LifecycleTransformer<TBShoppingDetailBean> transformer){
        mRepository.seckillDetail(seckillGoodsId)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .compose(transformer)
                .subscribe(bean -> {
