...
import com.example.administrator.jipinshop.activity.message.system.MessageSystemView;
import com.example.administrator.jipinshop.adapter.MessageDailyAdapter;
 ...
 * @Describe 商品样式
 */
public class MessageDailyActivity extends BaseActivity implements View.OnClickListener, MessageSystemView, OnRefreshListener, OnLoadMoreListener, MessageDailyAdapter.OnItem {
    ...
    private String id = "";
    private MessageDailyAdapter mAdapter;
    ...
    private void initView() {
        ...
        mList = new ArrayList<>();
        mAdapter = new MessageDailyAdapter( mList,this);
