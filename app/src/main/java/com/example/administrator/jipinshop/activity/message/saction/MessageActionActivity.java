...
import com.example.administrator.jipinshop.adapter.MessageActionAdapter;
 ...
 * @Describe 图片广告样式
 */
public class MessageActionActivity extends BaseActivity implements View.OnClickListener, OnRefreshListener, OnLoadMoreListener, MessageSystemView, MessageActionAdapter.OnItem {
    ...
    private void initView() {
        ...
        mList = new ArrayList<>();
        mAdapter = new MessageActionAdapter( mList,this);
