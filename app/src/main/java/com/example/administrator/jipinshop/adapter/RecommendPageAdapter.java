 ...
 * @Describe
 */
public class RecommendPageAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener{
    private List<RecommendFragmentBean.AdListBean> mAdListBeans;
    ...
    public void setList(List<RecommendFragmentBean.AdListBean> list) {
        mAdListBeans = list;
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_recommend_banner, container, false);
