...
public class HealthFragmentRecyclerAdapter   extends RecyclerView.Adapter{

    private List<HealthFragmentBean.ListBean> mList;
    ...
    public HealthFragmentRecyclerAdapter(List<HealthFragmentBean.ListBean> list, Context context) {
        mList = list;
        mContext = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        switch (i) {
            case CONTENT:
                HealthItemBinding binding = DataBindingUtil.inflate(LayoutInflater.from(mContext),R.layout.health_item,viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        switch (type) {
            case CONTENT:
                HealthFragmentRecyclerAdapter.ViewHolder viewHolder = (ViewHolder) holder;
...
//        ImageManager.displayRoundImage(mList.get(position).getRankGoodImg(), viewHolder.getBinding().itemImage, R.color.transparent,  R.color.transparent, 10);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private HealthItemBinding mBinding;
        ...
        public HealthItemBinding getBinding() {
            return mBinding;
        }
    }
