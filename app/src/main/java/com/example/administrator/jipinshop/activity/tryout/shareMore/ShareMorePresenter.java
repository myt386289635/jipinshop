 ...
 * @Describe
 */
public class ShareMorePresenter {

    private Repository mRepository;
    private ShareMoreView mView;

    public void setView(ShareMoreView view) {
        mView = view;
    }

    @Inject
    public ShareMorePresenter(Repository repository) {
    ...
    public void voteUserList(String page ,String trialId , LifecycleTransformer<SucBean<TryDetailBean.DataBean.ApplyUserListBean>> ransformer){
        mRepository.voteUserList(page, trialId)
