package com.example.administrator.jipinshop.activity.coupon;
...
import com.example.administrator.jipinshop.databinding.ActivityCouponBinding;
...
public class CouponActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        mBinding.inClude.titleTv.setText("优惠券");
        mFragments = new ArrayList<>();
        mAdapter = new HomeFragmentAdapter(getSupportFragmentManager());
        mFragments.add(CouponFragment.getInstance("1"));
        mFragments.add(CouponFragment.getInstance("2"));
        mFragments.add(CouponFragment.getInstance("3"));
    ...
    public void initTabLayout() {
        ...
        mBinding.tabLayout.post(() -> {
            ...
            int dp10 = (mBinding.tabLayout.getWidth() - totle) / 3;
