 ...
 * @Describe
 */
public class TabCommenAdapter extends RecyclerView.Adapter{
    ...
    public TabCommenAdapter(List<HomeCommenBean.DataBean> commenBeans, Context context) {
    ...
    public int getItemCount() {
        return mCommenBeans.size() == 0 ? 0 : mCommenBeans.size();
    }
