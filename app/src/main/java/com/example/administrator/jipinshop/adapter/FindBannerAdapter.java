 ...
 * @Describe
 */
public class FindBannerAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener{
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_find_banner, container, false);
