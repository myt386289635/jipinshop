 ...
 * @Describe
 */
public class ZeroDetailPresenter {

    private Repository mRepository;
    private ZeroDetailView mView;

    public void setView(ZeroDetailView view) {
        mView = view;
    }

    @Inject
    public ZeroDetailPresenter(Repository repository) {
    ...
    public void zeroDetail(String id , LifecycleTransformer<TBShoppingDetailBean> transformer){
        mRepository.zeroDetail(id)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .compose(transformer)
                .subscribe(bean -> {
    ...
    public void apply(String allowanceGoodsId , LifecycleTransformer<ImageBean> transformer){
        mRepository.zeroApply(allowanceGoodsId)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .compose(transformer)
                .subscribe(bean -> {
