...
public class RoundTransform extends BitmapTransformation {
    ...
    private static final String ID = "jp.wasabeef.glide.transformations.RoundTransform." + VERSION;
    ...
    public boolean equals(Object o) {
        return o instanceof RoundTransform &&
                ((RoundTransform) o).radius == radius &&
                ((RoundTransform) o).diameter == diameter &&
                ((RoundTransform) o).margin == margin &&
                ((RoundTransform) o).cornerType == cornerType;
    }
