 ...
 * @Describe 对比评测
 */
class ComparActivity : BaseActivity(), View.OnClickListener, OnRefreshListener, OnLoadMoreListener, ComparAdapter.OnClickItem, ComparView {

    @Inject
    lateinit var mPresenter: ComparPresenter

    private lateinit var  mBinding : ActivityArticleMoreBinding
    private lateinit var  adapter : ComparAdapter
    ...
    private fun initView() {
        ...
        mList = mutableListOf()
        adapter = ComparAdapter(this,mList)
