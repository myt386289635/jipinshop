 ...
 * @Describe
 */
class EvaUnPackingPresenter {

    private var repository : Repository
    private lateinit var mView: EvaUnPackingView

    fun setView(view: EvaUnPackingView){
        mView = view
    }
    ...
    fun setDate( page : Int , transformer : LifecycleTransformer<SucBean<EvaEvaBean.DataBean>>){
        repository.unBoxList("","1" , page)
