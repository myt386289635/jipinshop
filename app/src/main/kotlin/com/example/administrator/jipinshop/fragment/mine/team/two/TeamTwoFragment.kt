 ...
 * @Describe
 */
class TeamTwoFragment : DBBaseFragment(), OnRefreshListener, OnLoadMoreListener, View.OnClickListener {

    @Inject
    lateinit var mPresenter: TeamTwoPresenter
    ...
    companion object{
        @JvmStatic
        fun getInstance(): TeamTwoFragment {
    ...
    override fun onRefresh() {
        ...
        (activity as TeamActivity).initOtherPage(1)
        mAdapter.notifyDataSetChanged()
        once[0] = false
    }
