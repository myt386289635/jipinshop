 ...
 * @Describe
 */
class ComparPresenter {

    private var repository: Repository
    private lateinit var mView : ComparView

    fun setView(view: ComparView){
        mView = view
    }
    ...
    fun setDate( categoryId : String  , page : Int , transformer : LifecycleTransformer<SucBean<EvaEvaBean.List2Bean>>){
        repository.unBoxList2(categoryId,"2" , page)
